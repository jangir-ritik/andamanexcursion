...
export const content = {
  ...
  trivia: {
    title: "Did you know?",
    text: "Jolly Buoy is a No Plastic Island known for untouched coral reefs & eco-friendly snorkelling.",
    highlightedPhrases: ["No Plastic Island", "eco-friendly snorkelling"],
  },
  largeCardSection: {
