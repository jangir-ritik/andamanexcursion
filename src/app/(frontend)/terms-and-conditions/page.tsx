...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (!page || page.publishingSettings?.status !== "published") {
    return {
      title: "Terms & Conditions | Andaman Excursion",
      description: "Read the terms and conditions for using Andaman Excursion services.",
    };
  }

  // Use SEO plugin data (meta field) or fallback to page data
  const seoTitle = page.meta?.title || page.title || "Terms & Conditions | Andaman Excursion";
  const seoDescription =
    page.meta?.description || "Read the terms and conditions for using Andaman Excursion services.";
